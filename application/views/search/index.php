                    ...
                    <div class="row">
                            ...
                            <div class="column">
                                ...
                                <div class="select-rv input">
                                    <select class="form-control" rel="locations" name="search-form[departure]"
                                        ...
                                        <?php \application\models\Tours::optionDeparture(isset($_GET['search-form']['departure']) ? $_GET['search-form']['departure'] : $model->departure) ?>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="column">
                                ...
                                <div class="select-rv input">
                                    <select class="form-control" rel="locations" name="search-form[category]"
                                        ...
                                        <?php \application\models\Tours::optionCats(isset($_GET['search-form']['category']) ? $_GET['search-form']['category'] : $model->id) ?>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-2">
                            <div class="column">
                                ...
                                <div class="select-rv input">
                                    <input type="" id="check_in" name="search-form[check_in]" value="<?=isset($_GET['search-form']['check_in']) ? $_GET['search-form']['check_in'] : ''?>"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="column">
                                ...
                                <div class="select-rv input">
                                    <select class="form-control" rel="night" name="search-form[total_person]"
                                        ...
                                        <?php for($i=1;$i<16;$i++): ?>
                                        <option <?=isset($_GET['search-form']['total_person'])  &&  $_GET['search-form']['total_person'] == $i ? 'selected' : ''?> value="<?=$i?>"><?=$i?></option>
                                        <?php endfor; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="column">
                                ...
                                <div class="select-rv input">
                                    <select class="form-control" rel="night" name="search-form[total_days]"
                                            id="search-form_nights">
                                        <?php for($i=1;$i<16;$i++): ?>
                                            <option <?=isset($_GET['search-form']['total_days'])  &&  $_GET['search-form']['total_days'] == $i ? 'selected' : ''?> value="<?=$i?>"><?=$i?></option>
                                        <?php endfor; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="column">
                                ...
                                <div class="select-rv input">
                                    <select class="form-control" rel="adults" name="search-form[price]"
                                        ...
                                        <option <?=isset($_GET['search-form']['price'])  &&  $_GET['search-form']['price'] == 1 ? 'selected' : ''?>  value="1">Dưới 1 triệu</option>
                                        <option <?=isset($_GET['search-form']['price'])  &&  $_GET['search-form']['price'] == 2 ? 'selected' : ''?> value="2">1 - 2 triệu</option>
                                        <option <?=isset($_GET['search-form']['price'])  &&  $_GET['search-form']['price'] == 3 ? 'selected' : ''?> value="3">2 - 4 triệu</option>
                                        <option <?=isset($_GET['search-form']['price'])  &&  $_GET['search-form']['price'] == 4 ? 'selected' : ''?> value="4">4 - 6 triệu</option>
                                        <option <?=isset($_GET['search-form']['price'])  &&  $_GET['search-form']['price'] == 5 ? 'selected' : ''?> value="5">Trên 6 triệu</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <div id="wrap-wish">
        <?php if (isset($tours) && !empty($tours)): ?>
            ...
            <?php foreach ($tours as $tour):
                $route = 'tours/detail';
                $slug = \application\models\Pages::model()->findOne(['route'=>$route,'model_id'=>$tour->id])->slug;
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="descrip-vrt">
                                        <h2 class="title"><a href="/<?= $slug ?>" target="_blank"
                                                             title=""><?= $tour->name ?></a>
                                        ...
                                        <div class="group">
                                            ...
                                            <div class="view"><a href="/<?= $slug ?>" title=""
                                                                 target="_blank"
